...
public:
    ...
    bool isSimilarTree(BinarySearchTree<T> & other) const;
...
template<class T>
void BinarySearchTree <T>::breadthFirst() const
{
...
template<class T>
bool BinarySearchTree <T>::isSimilarTree(BinarySearchTree <T> &other) const
{
  std::cout<<"First tree in infix traversal: "<<std::endl;
  T * firstArray = this->iterativeInorderWalk();
  std::cout<<"Second tree in infix traversal: "<<std::endl;
  T * secondArray= other.iterativeInorderWalk();
