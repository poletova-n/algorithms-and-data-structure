...
public:
  ...
  void breadthways() const;

  bool isEqual(const BinarySearchTree<T>& other) const;
...
template<class T>
void BinarySearchTree<T>::breadthways() const
{
...
template<class T>
bool BinarySearchTree<T>::isEqual(const BinarySearchTree<T>& other) const
{
  if (getCount() != other.getCount()) {
    return false;
  }
  if (root_ == nullptr) {
    return other.root_ == nullptr;
  }
